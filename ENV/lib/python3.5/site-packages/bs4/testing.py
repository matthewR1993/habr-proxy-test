...
class HTMLTreeBuilderSmokeTest(object):
    ...
    """A basic tests of a treebuilder's competence.
...
<body>Goodbye.</body>
    ...
    def test_processing_instruction(self):
        # We tests both Unicode and bytestring to verify that
...
<html>
<head>
<title>Ordinary HEAD element tests</title>
</head>
...
"""
    ...
    def test_real_iso_latin_document(self):
        # Smoke tests of interrelated functionality, using an
    ...
    def test_real_shift_jis_document(self):
        # Smoke tests to make sure the parser can handle a document in
    ...
    def test_real_hebrew_document(self):
        # A real-world tests to make sure we can convert ISO-8859-9 (a
...
class HTML5TreeBuilderSmokeTest(HTMLTreeBuilderSmokeTest):
    """Smoke tests for a tree builder that supports HTML5."""
