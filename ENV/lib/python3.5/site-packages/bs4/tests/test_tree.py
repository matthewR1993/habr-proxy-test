...
class TestCDAtaListAttributes(SoupTest):
    ...
    def test_cdata_attribute_applying_only_to_one_tag(self):
        ...
        soup = self.soup(data)
        # We saw in another tests that accept-charset is a cdata-list
...
"""
    ...
    def test_encoding_substitution_doesnt_happen_if_tag_is_strained(self):
        ...
        # meta tag got filtered out by the strainer. This tests makes
...
<a href="#" id="s1a2">span1a2 <span id="s1a2s1">tests</span></a>
<span class="span2">
